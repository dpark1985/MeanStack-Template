...
const serverIp          = require('../../../config/serverConfig');
...
router.post('/doPush', function (req, res, next) {
  ...
  req.db.devices.find({}, function (err, data) {
    ...
    req.body.imgThumbSrc[0].src = serverIp.getServerIp() + req.body.imgThumbSrc[0].src;

    for(var k=0; k<req.body.imgSeriesSrc.length; k++){
      req.body.imgSeriesSrc[k].src = serverIp.getServerIp() + req.body.imgSeriesSrc[k].src;
    }
